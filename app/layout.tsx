...
export const metadata: Metadata = {
  ...
  description: 'Portfolio of Tahaberk Soysal, a Front-end Developer specializing in Next.js, TypeScript, and building validated SaaS products.',
  keywords: ['Front-end Developer', 'Next.js Developer', 'TypeScript', 'SahaDijital', 'Web Developer Portfolio'],
