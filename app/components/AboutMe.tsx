...
export default function About() {
  ...
  return (
    <section className='my-12'>
        <h2 className="font-satoshi text-accent text-2xl tracking-tight font-bold mb-5">About me</h2>
      ...
      <div className="w-full max-w-3xl bg-white rounded-4xl p-6  md:p-10 flex flex-col gap-6 text-base md:text-lg leading-relaxed text-text-primary shadow-sm">
        <p>
          I'm a front-end developer based in Turkey, focused on building products that 
          solve real problems — not just writing code that passes review.
        </p>
        <p>
          I've built and shipped three projects independently: a SaaS reservation 
          platform for soccer field owners, a resume builder with live preview and PDF 
          export, and a Pomodoro Chrome extension built in collaboration with a 
          designer. Each one taught me something tutorials never could.
        </p>
        <p>
        ...
        <p className="font-medium text-black">
          Currently looking for a remote front-end role at a small, product-focused 
          team where I can contribute beyond the task list.
        </p>
      </div>
      </div>
